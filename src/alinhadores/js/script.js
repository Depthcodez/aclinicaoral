...
document.addEventListener('DOMContentLoaded', () => {
    ...
    link.addEventListener('click', e => {
      ...
      setTimeout(() => {
        const redirectParams = new URLSearchParams({
          url: href,
          procedimento: 'Alinhadores Estéticos',
          source: 'Landing Page Alinhadores',
  ...
  callLinks.forEach(link => {
    link.addEventListener('click', async e => {
      ...
      const payload = {
        evento: 'call_click',
        procedimento: link.dataset.procedimento || 'Alinhadores Estéticos',
        source: link.dataset.source || 'Landing Page Alinhadores',
      ...
      if (typeof fbq === 'function') {
        try {
          fbq('trackCustom', 'Lead_Ligacao_Alinhadores')
        } catch (err) {
      ...
      if (window.dataLayer) {
        window.dataLayer.push({
          event: 'Lead_Ligacao_Alinhadores',
          ...payload
        })
      }
