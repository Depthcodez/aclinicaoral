      ...
      reviews
        ...
        .forEach(review => {
          if (review.rating >= 3) {
            const li = $('<li></li>')
            li.html(
              `<div><div class="text-apost"><p class="apost"></p><p class="depoiment">${review.text}</p></div><p class="author"> - ${review.author_name}</p></p><p class="rating">Nota: ${review.rating}/5</p></div>`
            )
